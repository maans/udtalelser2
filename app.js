...
// Used for cache-busting verification in the UI.
  ...
  const BUILD_ID = '2026-05-26_smalmargin_directprint';
...
<head>
  ...
  <style>
    ...
    @media print{
      ...
      body.print-single .signatures{ position: fixed; bottom: 22px; left: 0; right: 0; width: 100%; }
      body.print-multi .page{ position: relative; }
      body.print-multi .content{ position: relative; min-height: 283mm; }
      body.print-multi .signatures{ position: absolute; bottom: 22px; left: 0; right: 0; width: 100%; }
      /* Sørg for at brødtekst aldrig kan løbe ned i signaturen */
      pre.statement{ padding-bottom: 95px; }
    }
